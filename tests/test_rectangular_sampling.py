...
def test_rectangular_footprint_covers_all_sampling_styles(
    ...
    coords = SamplingCoords(
        96.7, 3.5, (10, 16), style=style, fov_type=fov_type, field_geometry="spherical"
    )
    ...
    if style.endswith("_as_grid"):
        assert coords.as_grid(coords.cartesian, sample_dim=0).shape == (10, 16, 2)
